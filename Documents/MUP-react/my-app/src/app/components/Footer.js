    ...
    <footer id="contatos" className="bg-purple-2 px-10 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row items-center justify-around">
        <div className="md:pb-[20rem] pb-5 text-center md:text-left">
          <h3 className="text-3xl mb-4">Quer saber mais?</h3>
        ...
        <div className="m-16 flex flex-col items-center md:items-start">
          <div className="mb-2 text-xl">Informações</div>
          <div className="mb-2 text-gray-1">Quem somos</div>
          <div className="mb-2 text-gray-1">Soluções</div>
          <div className="text-gray-1">Produtos</div>
        </div>
