  ...
  return (
    <div id="produtos" className="min-h-screen mt-12 ">
      ...
      <p className="text-black-3 flex justify-center items-center text-center mb-20">
        Nossos instrumentos foram desenvolvidos para traduzirem
        características complexas <br></br> dos atores educacionais
        (estudantes, pais e professores) de forma simples, concisa e
        <br></br> focadas na melhoria dos resultados.
      </p>
      ...
      <div className="card bg-purple-1 p-6 rounded-md shadow-md text-center mx-4 my-4 lg:w-[25rem] h-80">
        ...
        <p className="card-description text-black-3">
          Mensuração de competências <br></br> socioemocionais.
        </p>
